...
import { FileText, MessageSquare, Bot, Zap, Target, LogOut, User, ChevronRight, Shield, Sparkles, Brain, PenLine } from 'lucide-react';
...
const FEATURES = [
  ...
  { icon: PenLine, title: 'Cover Letter Generator', desc: 'Generate personalized cover letters tailored to any job description in seconds' },
    ...
    <div className="min-h-screen bg-[#0a0a0f] overflow-x-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20 text-center">
        ...
        <p className="text-xl text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
          Get instant ATS score, optimize your resume, generate cover letters, prepare for interviews — all powered by AI, completely free.
        </p>
        ...
        <div className="flex items-center justify-center gap-12 mt-16 flex-wrap">
          {[['ATS Analyzer', 'Instant Score'], ['Cover Letter', 'AI Generated'], ['Interview Prep', 'Personalized'], ['AI Coach', '24/7 Available']].map(([title, sub]) => (
